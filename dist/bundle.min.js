...
},{"./createStore":18,"./utils/warning":20,"lodash/isPlainObject":11}],17:[function(require,module,exports){
...
"use strict";function startApp(e){e&&window.console.error(e),m.route(document.getElementById("app"),"/",{"/":home})}var m=require("mithril"),store=require("./store"),home=require("./modules/home");store.init(),startApp();

},{"./modules/home":25,"./store":26,"mithril":12}],25:[function(require,module,exports){
"use strict";function homeView(){var e=store.getState();return m("div",null,m("input",{value:e.home.message,oninput:function(e){store.dispatch({type:"home:editMessage",message:e.target.value})}}),m("h3",null,e.home.message))}var m=require("mithril"),_require=require("icepick"),set=_require.set,store=require("../store"),initialState={message:"Hello World!"};store.addReducer("home",function(e,t){switch(t.type){case"home:editMessage":return set(e,"message",t.message);default:return e||initialState}}),module.exports={view:homeView};

},{"../store":26,"icepick":1,"mithril":12}],26:[function(require,module,exports){
"use strict";var m=require("mithril"),_require=require("redux"),createStore=_require.createStore,combineReducers=_require.combineReducers,compose=_require.compose,applyMiddleware=_require.applyMiddleware,store={reducers:{},addReducer:function(e,r){store.reducers[e]=r},init:function(){var e=combineReducers(store.reducers),r=[],t=compose,i=createStore(function(r,t){return"$LOAD"===t.type?t.state:e(r,t)},t(applyMiddleware.apply({},r)));window.__REDUX_DEVTOOLS_EXTENSION__&&i.subscribe(m.redraw.bind(m)),store.dispatch=i.dispatch,store.getState=i.getState,store.subscribe=i.subscribe}};module.exports=store;

},{"mithril":12,"redux":19}]},{},[24]);
